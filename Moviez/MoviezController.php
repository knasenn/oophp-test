 ...
 */
class MoviezController implements AppInjectableInterface
{
    ...
    public function initActionGet()
    {
        ...
        return $response->redirect("moviez/play");
    }
    ...
    public function playActionPost()
    {
        ...
        if ($reset) {
            return $response->redirect("moviez/init");
        }
        ...
        if ($roll) {
            ...
            if ($check[0] == 0) {
                ...
                return $response->redirect("moviez/playComp");
            } else {
