 ...
 */
class Hundra2Controller implements AppInjectableInterface
{
    ...
    public function initActionGet()
    {
        ...
        return $response->redirect("hundra2/play");
    }
    ...
    public function playActionPost()
    {
        ...
        if ($reset) {
            return $response->redirect("hundra2/init");
        }
        ...
        if ($roll) {
            ...
            if ($check[0] == 0) {
                ...
                return $response->redirect("hundra2/playComp");
            } else {
